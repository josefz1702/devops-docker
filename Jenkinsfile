pipeline {
    ...
    stages {
        ...
        stage('Integration Test') {
            ...
            steps {
              sh 'docker run --rm --name build -w /var/jenkins_home/workspace/spring-boot-pipeline --volumes-from jenkins maven:3.3-jdk-8 mvn clean package -Dmaven.test.skip=true'
